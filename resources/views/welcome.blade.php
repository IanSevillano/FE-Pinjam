  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="#" class="logo d-flex align-items-center me-auto">
        ...
        <h1 class="sitename">Sistem Peminjaman Ruangan</h1>
      </a>
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
            ...
            <p>Sistem Peminjaman Ruangan Kelas</p>
            <div class="d-flex">
              <a href="#about" class="btn-get-started">Login</a>
            </div>
          </div>
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="100">
            <img src="{{asset('enno/assets/img/students_09.jpg')}}" class="img-fluid animated" alt="">
          </div>
        </div>
      </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <h2>Tentang Kita</h2>
        <p>Sistem ini bertujuan untuk meminjam ruangan kelas dan kita bisa melihat ruangan mana yang tersedia dan tidak tersedia yang tertera pada jadwal</p>
